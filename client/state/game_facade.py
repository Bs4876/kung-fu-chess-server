...
class GameFacade:
    ...
    def subscribe_opponent_status(self, callback) -> None:
        """No-op: local hot-seat play has no networked opponent that can
        disconnect. Kept so GameScreen can call this on either facade
        without checking which one it has - see NetworkGameFacade's real
        implementation."""
