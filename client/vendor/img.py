"""Vendored graphics primitive: the only class allowed to touch pixels directly.

Treated as read-only. Anything this class doesn't provide (a non-blocking render
loop, mouse events, animation timing) is built on top of it in client/graphics and
client/animation, never by editing this file.
"""
