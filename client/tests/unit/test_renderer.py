...
def test_render_draws_the_disconnect_countdown():
    renderer = build()
    canvas = renderer.render(FakeSnapshot({}), dt_ms=16, disconnect_countdown_seconds=7)
    assert canvas.texts == [("Opponent disconnected - auto-resign in 7s", 100, 50)]
